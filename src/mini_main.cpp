...
int main(){
	...
	std::cout <<"Done \n\n";
	double target_U0_density = multiple_DLR.non_interacting_density(mfreq,params.mu);
	std::cout << "Non interacting density n= " << target_U0_density <<" \n\n";
	//params.target_n = target_U0_density;
    ...
    for (int i=1;i<iter;i++){
		...
		auto GF = multiple_DLR.G_from_DLR_SE_M_DMFT(SE, mfreq,mu);
