...
public:
params_param params; AmiGraph::gg_matrix_t ggm; //declaration fields
ggm_mDLR(params_param _params, AmiGraph::gg_matrix_t _ggm);
std::vector<AmiGraph::graph_t> graph_list;
